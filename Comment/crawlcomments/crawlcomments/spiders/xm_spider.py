...
class XiaomiCommentSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        return reqs
        # debug
        # url = "https://comment.huodong.mi.com/comment/entry/getList?goods_id=8625&v_pid=&orderby=1&showimg=0&profile_id=0&jsonpcallback=jQuery111301510225871124462_1540446534217&_=1540446534221&pagesize=1&pageindex=" + str(
        #     1)
        # headers = {
        #     "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.111 Safari/537.36",
        #     "Referer": url
